    ...
    test_cases = [
        QTestCase("SM", "TC_PROT_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid=100),
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                            start_wid=100),
                   TestFunc(btp.gap_pair, pts_bd_addr, 0, start_wid=100)]),
        QTestCase("SM", "TC_PROT_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.gap_adv_ind_on),
                   TestFunc(btp.gap_pair, pts_bd_addr, 0, start_wid=109)]),
        ...
        QTestCase("SM", "TC_JW_BV_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                            start_wid=100),
                   TestFunc(btp.gap_pair, pts_bd_addr, 0, start_wid=100),
                   TestFunc(btp.gap_disconn, pts_bd_addr, 0, start_wid=102),
        ...
        QTestCase("SM", "TC_PKE_BV_01_C",
                  ...
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                                 start_wid=100),
                        TestFunc(btp.gap_pair, pts_bd_addr, 0, start_wid=108),
                        TestFunc(btp.gap_passkey_disp_ev, pts_bd_addr, 1, True,
                                 start_wid=108)]),
        ...
        QTestCase("SM", "TC_PKE_BV_04_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                            start_wid=100),
                   TestFunc(btp.gap_pair, pts_bd_addr, 0, start_wid=100),
                   TestFunc(btp.gap_passkey_disp_ev, pts_bd_addr, 1,
                            start_wid=100)]),
        ...
        QTestCase("SM", "TC_EKS_BI_01_C",
                  ...
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                                 start_wid=100),
                        TestFunc(btp.gap_pair, pts_bd_addr, 0,
                                 start_wid=100)]),
        ...
        QTestCase("SM", "TC_SIP_BV_02_C",
                  ...
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        TestFunc(btp.gap_set_io_cap, 0),
                        TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid=101),
                        TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                                 start_wid=101),
                        TestFunc(btp.gap_passkey_disp_ev, pts_bd_addr, 1, True,
                                 start_wid=101)]),
