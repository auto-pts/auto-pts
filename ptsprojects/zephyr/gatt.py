...
def test_cases_client(pts_bdaddr):
    ...
    test_cases = [
        QTestCase("GATT", "TC_GAC_CL_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.core_reg_svc_gatts),
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_exchange_mtu, 0, pts_bdaddr,
                            start_wid = 12),
                   TestFunc(btp.gattc_write_long, 0, pts_bdaddr,
                            MMI.arg_1, 0, '12', MMI.arg_2, start_wid = 69),
                   TestFunc(btp.gattc_write_long_rsp, start_wid = 69),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #FIXME Verification of data
        #description: Please confirm IUT receive primary services uuid = '66FA'O ,
        #Service start handle = 0x0001, end handle = 0x0003 Service start handle = 0x0030,
        #end handle = 0x0032 Service start handle = 0x0040, end handle = 0x0042
        #Service start handle = 0x0050, end handle = 0x0052 Service start handle = 0x0090,
        #end handle = 0x0096 in database. Click Yes if IUT receive it, otherwise click No.
        QTestCase("GATT", "TC_GAD_CL_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_prim_uuid, 0, pts_bdaddr,
        ...
        #End Group Handle = 0x0026,Service UUID = 0x00003EA1000000000123456789ABCDEF
        #
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_03_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   #NOTE: We cannot discover all services at first, so we look for included at once
                   TestFunc(btp.gattc_find_included, 0, pts_bdaddr, '0001',
                            'FFFF', start_wid = 15),
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_04_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_all_chrc, 0, pts_bdaddr, MMI.arg_2, MMI.arg_3, start_wid = 27),
                   TestFunc(btp.gattc_disc_all_chrc_rsp, start_wid = 27),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #FIXME Verification of data
        #description: Please confirm IUT receive characteristic handle=0x00E5
        #UUID=0x4509  in database. Click Yes if IUT receive it, otherwise click No.
        #PTS issue #14012
        QTestCase("GATT", "TC_GAD_CL_BV_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_chrc_uuid, 0, pts_bdaddr,
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_all_desc, 0, pts_bdaddr,
                            MMI.arg_1, MMI.arg_2, start_wid = 31),
                   TestFunc(btp.gattc_disc_all_desc_rsp, start_wid = 31),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        # TODO
        #handle_mmi_style_yes_no1, 50 "Please confirm IUT receive characteristic value='07'O
        #in random selected adopted database. Click Yes if IUT receive it, othwise click No.
        #\n\nDescription: Verify that the Implementation Under Test (IUT) can send Read characteristic
        #to PTS random select adopted database."
        QTestCase("GATT", "TC_GAR_CL_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.core_reg_svc_gatts),
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bdaddr, MMI.arg_1, start_wid = 48),
                   TestFunc(btp.gattc_read_rsp, start_wid = 48),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #Please confirm IUT receive Invalid handle error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #handle_mmi_style_yes_no1, 41 'Please confirm IUT receive read is not permitted error.
        #Click Yes if IUT receive it, othwise click No.\n\nDescription: Verify that the Implementation
        #Under Test (IUT) indicate read is not permitted error when read a characteristic.
        QTestCase("GATT", "TC_GAR_CL_BI_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #Please confirm IUT receive authorization error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_03_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive authentication error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_04_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #Please confirm IUT receive encryption key size error. Click Yes if IUT receive it, othwise click No.
        #Description: Verify that the Implementation Under Test (IUT) indicate encryption key size error when read a characteristic.
        QTestCase("GATT", "TC_GAR_CL_BI_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT Handle='b1'O characteristic value='12'O in random selected adopted database.
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_04_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #Please confirm IUT receive read is not permitted error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_12_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive Invalid offset error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_13_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read_long, 0, pts_bdaddr, MMI.arg_1, MMI.arg_2, 1, start_wid = 53),
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_14_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive authorization error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_15_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive authentication error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_16_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive encryption key size error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_17_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO - No implementation to use multiple MMI arguments in tuple
        QTestCase("GATT", "TC_GAR_CL_BV_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.core_reg_svc_gatts),
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read_multiple, 0, pts_bdaddr, (MMI.arg_1, MMI.arg_2), start_wid = 57),
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_22_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gattc_read_multiple_rsp, start_wid = 57)]),
        #TODO
        #description: Please confirm IUT receive Descriptor value='44'O in random selected adopted database.
        #Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bdaddr, MMI.arg_1, start_wid = 58),
                   TestFunc(btp.gattc_read_rsp, start_wid = 58),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive read is not permitted error. Click Yes if IUT receive it,
        #othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_23_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive Invalid handle error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_24_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive authorization error. Click Yes if IUT receive it, othwise click No.
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_27_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT Handle='b7'O characteristic value='A600A600'O
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_07_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive read is not permitted error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_28_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive Invalid offset error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_29_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.core_reg_svc_gatts),
                   TestFunc(btp.gap_conn, pts_bdaddr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bdaddr, MMI.arg_1, start_wid = 60),
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_32_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive encryption key size error. Click Yes if IUT receive it, othwise click No.
        QTestCase("GATT", "TC_GAR_CL_BI_33_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
        #TODO
        #description: Please confirm IUT receive Application error. Click Yes if IUT receive it, othwise click No.
        ...
        QTestCase("GATT", "TC_GAW_CL_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_write_without_rsp, 0, pts_bdaddr,
        ...
        QTestCase("GATT", "TC_GAW_CL_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_signed_write, 0, pts_bdaddr,
        ...
        QTestCase("GATT", "TC_GAW_CL_BV_03_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_write, 0, pts_bdaddr,
        ...
        QTestCase("GATT", "TC_GAT_CL_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bdaddr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bdaddr, MMI.arg_1,
                            start_wid = 48),
                   TestFunc(btp.gattc_read_rsp, start_wid = 48),
                   TestFunc(btp.gap_disconn, pts_bdaddr, 0, start_wid = 3),
                   TestFunc(btp.gap_disconnected_ev, pts_bdaddr, 1, start_wid = 3)]),
