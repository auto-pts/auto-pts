...
def test_cases():
    ...
    test_cases = [
        ...
        QTestCase("GATT", "TC_GAD_SR_BV_01_C",
                  ...
                  [TestIntr(1, "OK"),
                   TestIntr(17, "OK", "Cancel", ("Please confirm IUT receive primary services", "Service = 0xAAAA"))]),
        QTestCase("GATT", "TC_GAD_SR_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_adv_ind_on)],
                  [TestIntr(1, "OK"),
                   TestIntr(23, "OK", "Cancel", ("Please confirm IUT have following primary services",
