    ...
    test_cases = [
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_04_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_all_chrc, 0, pts_bd_addr, MMI.arg_2, MMI.arg_3, start_wid = 27),
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1,
                            start_wid = 2),
                   TestFunc(btp.gattc_disc_all_desc, 0, pts_bd_addr,
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gattc_read, 0, pts_bd_addr, MMI.arg_1, start_wid = 48),
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_13_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read_long, 0, pts_bd_addr, MMI.arg_1, MMI.arg_2, 1, start_wid = 53),
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read_multiple, 0, pts_bd_addr, (MMI.arg_1, MMI.arg_2), start_wid = 57),
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bd_addr, MMI.arg_1, start_wid = 58),
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_29_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_conn, pts_bd_addr, 0, start_wid = 2),
                   TestFunc(btp.gap_connected_ev, pts_bd_addr, 1, start_wid = 2),
                   TestFunc(btp.gattc_read, 0, pts_bd_addr, MMI.arg_1, start_wid = 60),
