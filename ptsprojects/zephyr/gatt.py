...
UUID = {'CEP':      '2900',  # Characteristic Extended Properties
        'CUD':      '2901',  # Characteristic User Description
        'CCC':      '2902',  # Characteristic Characteristic Configuration
        'SCC':      '2903',  # Characteristic Configuration
        'CPF':      '2904',  # Characteristic Presentation Format
        'CAF':      '2905',  # Characteristic Aggregate Format
        'DeviceName': '2A00',
        'Appearance':   '2A01',
        'Gender':   '2A8C',
        'DateOfBirth': '2A85',
    ...
    test_cases = [
        QTestCase("GATT", "TC_GAC_SR_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
                   TestFunc(btp.gatts_add_char, 1,
                            Prop.read | Prop.write | Prop.nofity,
                            Perm.read | Perm.write, UUID['Vendor16_2']),
        ...
        QTestCase("GATT", "TC_GAD_SR_BV_03_C",
                  ...
                  verify_wids={24: ("Attribute Handle = 0x0002",
                                    ...
                                    "Service UUID = 0x" + UUID['Vendor16_1'])}),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_02_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.broadcast, Perm.write, UUID['Vendor16_2']),
                      TestFunc(btp.gatts_set_val, 2, '0123'),
                      TestFunc(btp.gatts_start_server),
                      TestFunc(btp.gap_adv_ind_on)]),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_06_C",
                  edit1_wids={111: UUID['Vendor16_2'], 110: "0003"},
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_07_C",
                  edit1_wids={119: UUID['Vendor16_3']},
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                          TestFunc(btp.core_reg_svc_gatts),
                          TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
                          TestFunc(btp.gatts_add_char, 1,
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_11_C",
                  edit1_wids={121: "0003", 122: UUID['Vendor16_2']},
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                          TestFunc(btp.core_reg_svc_gatts),
                          TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_18_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.write, Perm.write, UUID['Vendor16_2']),
                      TestFunc(btp.gatts_set_val, 2, '0123'),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read | Prop.write | Prop.nofity,
                               Perm.read | Perm.write, UUID['Vendor16_3']),
                      TestFunc(btp.gatts_set_val, 4, '4567'),
                      TestFunc(btp.gatts_start_server),
                      TestFunc(btp.gap_adv_ind_on)]),
        QTestCase("GATT", "TC_GAR_SR_BI_19_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_set_val, 2, '0123'),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read, Perm.read, UUID['Vendor16_3']),
                      TestFunc(btp.gatts_set_val, 4, '4567'),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read | Prop.write | Prop.nofity,
                               Perm.read | Perm.write, UUID['Vendor16_4']),
                      TestFunc(btp.gatts_set_val, 6, '4567'),
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read | Prop.write | Prop.nofity,
                               Perm.read | Perm.write, UUID['Vendor16_5']),
        ...
        QTestCase("GATT", "TC_GAR_SR_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_1']),
                   TestFunc(btp.gatts_add_char, 1,
                            Prop.read, Perm.read, UUID['Vendor16_2']),
                   TestFunc(btp.gatts_set_val, 2, '0123456789ABCDEF'),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_23_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read, Perm.read, UUID['Vendor16_2']),
                      TestFunc(btp.gatts_set_val, 2, '0123456789ABCDEF'),
                      TestFunc(btp.gatts_add_desc, 2, 0x00, UUID['Vendor16_3']),
                      TestFunc(btp.gatts_set_val, 4, 'FEDCBA9876543210'),
                      TestFunc(btp.gatts_start_server),
                      TestFunc(btp.gap_adv_ind_on)]),
        QTestCase("GATT", "TC_GAR_SR_BI_24_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_char, 1,
                               Prop.read, Perm.read, UUID['Vendor16_1']),
                      TestFunc(btp.gatts_set_val, 2, '0123456789ABCDEF'),
                      TestFunc(btp.gatts_add_desc, 2, Perm.read,
                               UUID['Vendor16_2']),
                      TestFunc(btp.gatts_set_val, 4, 'FEDCBA9876543210'),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_25_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_desc, 2,
                            Perm.read | Perm.authz, UUID['Vendor16_2']),
                   TestFunc(btp.gatts_set_val, 4, 'FEDCBA9876543210'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)]),
        ...
        QTestCase("GATT", "TC_GAR_SR_BI_27_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_set_val, 2, '0123456789ABCDEF'),
                   TestFunc(btp.gatts_add_desc, 2,
                            Perm.read | Perm.read_enc, UUID['Vendor16_3']),
                   TestFunc(btp.gatts_set_val, 4, 'FEDCBA9876543210'),
                   TestFunc(btp.gatts_set_enc_key_size, 4, 0x0f),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)]),
        ...
        QTestCase("GATT", "TC_GAW_SR_BI_20_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_desc, 2, 0, UUID['Vendor16_3']),
        ...
        QTestCase("GATT", "TC_GAW_SR_BI_22_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_set_val, 2, '0123456789ABCDEF'),
                   TestFunc(btp.gatts_add_desc, 2,
                            Perm.read | Perm.write | Perm.authz, UUID['Vendor16_2']),
                   TestFunc(btp.gatts_set_val, 4, 'FEDCBA9876543210'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)]),
        ...
        QTestCase("GATT", "TC_GPA_SR_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   TestFunc(btp.core_reg_svc_gatts),
                   TestFunc(btp.gatts_add_svc, 1, UUID['Vendor16_1']),
                   TestFunc(btp.gatts_add_char, 1, Prop.read,
                            Perm.read, UUID['Vendor16_2']),
                   TestFunc(btp.gatts_set_val, 2, '1234'),
                   TestFunc(btp.gatts_add_svc, 0, UUID['Vendor16_3']),
                   TestFunc(btp.gatts_add_inc_svc, 1),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)],
                  verify_wids={102: ("Attribute Handle = 0x0001",
