    ...
    test_cases = [
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_01_C",
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev,
                                 pts_bd_addr, 1, start_wid=2),
                        TestFunc(btp.gattc_read, 0, pts_bd_addr,
                                 MMI.arg_1, start_wid=48),
                        TestFunc(btp.gattc_read_rsp,
                                 store_val=True, start_wid=48),
                        TestFunc(btp.gap_disconn, pts_bd_addr, 0, start_wid=3),
                        TestFunc(btp.gap_disconnected_ev, pts_bd_addr, 1,
                                 start_wid=3)],
        ...
        QTestCase("GATT", "TC_GAR_CL_BI_13_C",
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev,
                                 pts_bd_addr, 1, start_wid=2),
                        TestFunc(btp.gattc_read_long, 0, pts_bd_addr,
                                 MMI.arg_1, MMI.arg_2, 1, start_wid=53),
                        TestFunc(btp.gattc_read_long_rsp,
                                 store_rsp=True, start_wid=53),
                        TestFunc(btp.gap_disconn, pts_bd_addr, 0, start_wid=3),
                        TestFunc(btp.gap_disconnected_ev, pts_bd_addr, 1,
                                 start_wid=3)],
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_05_C",
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev,
                                 pts_bd_addr, 1, start_wid=2),
                        TestFunc(btp.gattc_read_multiple, 0, pts_bd_addr,
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_06_C",
                  ...
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev,
                                 pts_bd_addr, 1, start_wid=2),
                        TestFunc(btp.gattc_read, 0, pts_bd_addr,
                                 MMI.arg_1, start_wid=58),
                        TestFunc(btp.gattc_read_rsp,
                                 store_val=True, start_wid=58),
                        TestFunc(btp.gap_disconn, pts_bd_addr, 0, start_wid=3),
                        TestFunc(btp.gap_disconnected_ev, pts_bd_addr, 1,
                                 start_wid=3)],
