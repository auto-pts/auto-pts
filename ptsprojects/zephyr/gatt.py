    ...
    test_cases = [
        ...
        QTestCase("GATT", "TC_GAD_CL_BV_03_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gattc_find_included,
                            ADDR_TYPE.BT_ADDR_LE_PUBLIC, pts_bd_addr, '0001',
                            'FFFF', start_wid=15),
        ...
        QTestCase("GATT", "TC_GAR_CL_BV_01_C",
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                        ...
                        TestFunc(btp.gap_connected_ev,
                                 pts_bd_addr, ADDR_TYPE.BT_ADDR_LE_PUBLIC,
                                 start_wid=2),
                        TestFunc(btp.gattc_read, ADDR_TYPE.BT_ADDR_LE_PUBLIC,
        ...
        QTestCase("GATT", "TC_GAW_CL_BV_03_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gap_connected_ev, pts_bd_addr,
                            ADDR_TYPE.BT_ADDR_LE_PUBLIC, start_wid=2),
                   TestFunc(btp.gattc_write, ADDR_TYPE.BT_ADDR_LE_PUBLIC,
