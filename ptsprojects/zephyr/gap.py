...
# Advertising data
ad=[(ad_type.uuid16_some, '1111'),
    (ad_type.gap_appearance, '1111'),
    (ad_type.name_short, binascii.hexlify('Tester')),
    (ad_type.manufacturer_data, '11111111'),
    (ad_type.uuid16_svc_data, '111111')]
