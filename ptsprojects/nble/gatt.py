    ...
    test_cases = [
        ...
        ZTestCase("GATT", "TC_GAR_SR_BV_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_char, 0,
                            Prop.read, Perm.read | Perm.write,
                            UUID.appearance),
                   TestFunc(btp.gatts_set_val, 0, '4567'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)],
        ...
        ZTestCase("GATT", "TC_GPA_SR_BV_01_C",
                  ...
                  verify_wids={102: (["Attribute Handle = '0001'",
                                      "Primary Service = '%s'" % UUID.gap_svc],
                                     ["Attribute Handle = '0008'",
                                      "Primary Service = '%s'" % UUID.gatt_svc],
                                     ["Attribute Handle = '0009'",
        ...
        ZTestCase("GATT", "TC_GPA_SR_BV_02_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)],
                  verify_wids={102: ("Attribute Handle = '0009'",
                                     "Service = '%s'" % UUID.VND16_1)}),
