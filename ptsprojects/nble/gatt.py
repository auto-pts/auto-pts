    ...
    test_cases = [
        ...
        ZTestCase("GATT", "TC_GAR_SR_BV_01_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_char, 0,
                            Prop.read | Prop.write | Prop.nofity,
                            Perm.read | Perm.write, UUID.VND16_2),
                   TestFunc(btp.gatts_set_val, 0, '01234abc'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)]),
        ...
        ZTestCase("GATT", "TC_GAR_SR_BI_05_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_set_val, 0, '0123456789ABCDEF'),
        ...
        ZTestCase("GATT", "TC_GAR_SR_BI_12_C",
                  ...
                  cmds=[TestFunc(btp.core_reg_svc_gap),
                          ...
                          TestFunc(btp.gatts_add_char, 0, 0x00, 0x00,
                                   UUID.VND16_2),
                          TestFunc(
                              btp.gatts_set_val, 0, 'FEDCBA98765432100123456789ABCDEF0123456789ABCDEF'),
                          TestFunc(btp.gatts_start_server),
                          TestFunc(btp.gap_adv_ind_on)]),
        ...
        ZTestCase("GATT", "TC_GAR_SR_BV_06_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_desc, 0, Perm.read,
                            UUID.VND16_3),
                   TestFunc(btp.gatts_set_val, 0, 'FEDCBA9876543210'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)],
                  verify_wids={52: ("Please confirm IUT Handle=\'c\'", "value=\'FEDCBA9876543210\'")}),
        ...
        ZTestCase("GATT", "TC_GAR_SR_BV_08_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_char, 0,
                            Prop.read, Perm.read, UUID.VND16_2),
                   TestFunc(
                       btp.gatts_set_val, 0, '0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABFFFF'),
                   TestFunc(btp.gatts_add_desc, 0, Perm.read,
                            UUID.VND16_3),
                   TestFunc(
                       btp.gatts_set_val, 0, 'FEDCBA98765432100123456789ABCDEF0123456789ABCDEF0123456789ABCDEF'),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)],
                  verify_wids={52: ("Please confirm IUT Handle=\'c\'",
                                    "value=\'FEDCBA98765432100123456789ABCDEF0123456789ABCDEF0123456789ABCDEF\'")}),
        ...
        ZTestCase("GATT", "TC_GAW_SR_BI_14_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_set_val, 0, '0123' * 20),
                      TestFunc(btp.gatts_start_server),
                      TestFunc(btp.gap_adv_ind_on)]),
        ...
        ZTestCase("GATT", "TC_GAW_SR_BI_20_C",
                  ...
                  cmds=[
                      ...
                      TestFunc(btp.gatts_add_char, 0,
                               Prop.read, Perm.read, UUID.VND16_2),
                      TestFunc(btp.gatts_set_val, 0, 'DCBA'),
                      TestFunc(btp.gatts_add_desc, 0, 0, UUID.VND16_3),
                      TestFunc(btp.gatts_set_val, 0, 'ABCD'),
                      TestFunc(btp.gatts_start_server),
                      TestFunc(btp.gap_adv_ind_on)]),
        ...
        ZTestCase("GATT", "TC_GAW_SR_BI_33_C",
                  [TestFunc(btp.core_reg_svc_gap),
                   ...
                   TestFunc(btp.gatts_add_char, 0, Prop.read | Prop.write,
                            Perm.read | Perm.write, UUID.VND16_2),
                   TestFunc(btp.gatts_set_val, 0, '0123456789ABCDEF' * 5),
                   TestFunc(btp.gatts_start_server),
                   TestFunc(btp.gap_adv_ind_on)]),
