...
def test_cases(ptses):
    ...
    test_cases_lt2 = [
        ...
        ZTestCase("MESH", "MESH/SR/PROX/BI-01-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BI-01-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-02-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-02-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-03-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-03-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-04-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-04-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-05-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-05-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-06-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-06-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-08-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-08-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-09-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-09-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-10-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-10-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-12-C", cmds=pre_conditions_lt2 +
                  [TestFunc(btp.mesh_iv_test_mode_autoinit)],
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/PROX/BV-12-C-LT2"),
        ZTestCase("MESH", "MESH/SR/PROX/BV-13-C", cmds=pre_conditions_lt2,
                  generic_wid_hdl=mesh_wid_hdl,
        ...
        ZTestCase("MESH", "MESH/SR/PROX/BV-14-C", cmds=pre_conditions_lt2 +
                  [TestFunc(btp.mesh_iv_test_mode_autoinit)],
                  generic_wid_hdl=mesh_wid_hdl,
    ...
    test_cases_slaves = [
        ...
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-02-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-02-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-02-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-03-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-03-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-03-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-04-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-04-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-04-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-05-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-05-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-05-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-06-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-06-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-06-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-08-C", 354),
                                  SynchPoint("MESH/SR/PROX/BV-08-C-LT2", 17)]),
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-08-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-08-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-09-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-09-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-09-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-10-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-10-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-10-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-12-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-12-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-12-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-13-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-13-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-13-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
        ZTestCaseSlave("MESH", "MESH/SR/PROX/BV-14-C-LT2",
                       ...
                       [TestFunc(get_stack().synch.add_synch_element,
                        ...
                        TestFunc(get_stack().synch.add_synch_element,
                                 [SynchPoint("MESH/SR/PROX/BV-14-C", 13),
                                  SynchPoint("MESH/SR/PROX/BV-14-C-LT2", 6)])],
                       generic_wid_hdl=mesh_wid_hdl),
