...
supported_svcs_cmds = {
    ...
    "BIP": {
        "service": 1 << defs.BTP_SERVICE_ID_BIP,
        "supported_commands": defs.BTP_BIP_CMD_READ_SUPPORTED_COMMANDS
    },
# GENERATOR append 1
    "VENDOR": {
...
reg_unreg_service = {
    ...
    "bip_reg": (defs.BTP_SERVICE_ID_CORE, defs.BTP_CORE_CMD_REGISTER_SERVICE,
                defs.BTP_INDEX_NONE, defs.BTP_SERVICE_ID_BIP),
# GENERATOR append 2
