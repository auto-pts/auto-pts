...
GATT_CLIENT_SUPPORTED_FEATURES_NO_FEATURES = 0
GATT_CLIENT_SUPPORTED_FEATURES_ROBUST_CACHING = BIT(0)
GATT_CLIENT_SUPPORTED_FEATURES_EATT = BIT(1)
GATT_CLIENT_SUPPORTED_FEATURES_MULT_NOTIFY = BIT(2)
