...
BTP_AVRCP_CMD_REQ_CONTINUING_RSP = 0x13
BTP_AVRCP_CMD_ABORT_CONTINUING_RSP = 0x14
BTP_AVRCP_CMD_SET_ABSOLUTE_VOLUME = 0x15
BTP_AVRCP_CMD_SET_ADDRESSED_PLAYER = 0x16
BTP_AVRCP_CMD_GET_FOLDER_ITEMS = 0x17
BTP_AVRCP_CMD_GET_TOTAL_NUMBER_OF_ITEMS = 0x18
BTP_AVRCP_CMD_SET_BROWSED_PLAYER = 0x19
BTP_AVRCP_CMD_CHANGE_PATH = 0x1A
BTP_AVRCP_CMD_GET_ITEM_ATTRS = 0x1B
BTP_AVRCP_CMD_PLAY_ITEM = 0x1C
BTP_AVRCP_CMD_SEARCH = 0x1D
BTP_AVRCP_CMD_ADD_TO_NOW_PLAYING = 0x1E
BTP_AVRCP_CMD_TG_REGISTER_NOTIFICATION = 0x1F
BTP_AVRCP_CMD_TG_CONTROL_PLAYBACK = 0x20
BTP_AVRCP_CMD_TG_CHANGE_PATH = 0x21
BTP_AVRCP_CMD_CA_CT_CONNECT = 0x22
BTP_AVRCP_CMD_CA_CT_DISCONNECT = 0x23
BTP_AVRCP_CMD_GET_IMAGE_PROPS = 0x24
BTP_AVRCP_CMD_GET_IMAGE = 0x25
BTP_AVRCP_CMD_GET_LINKED_THUMBNAIL = 0x26
...
BTP_AVRCP_EV_REQ_CONTINUING_RSP_RSP = 0x91
BTP_AVRCP_EV_ABORT_CONTINUING_RSP_RSP = 0x92
BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_RSP = 0x93
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP = 0x94
BTP_AVRCP_EV_GET_FOLDER_ITEMS_RSP = 0x95
BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_RSP = 0x96
BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP = 0x97
BTP_AVRCP_EV_CHANGE_PATH_RSP = 0x98
BTP_AVRCP_EV_GET_ITEM_ATTRS_RSP = 0x99
BTP_AVRCP_EV_PLAY_ITEM_RSP = 0x9A
BTP_AVRCP_EV_SEARCH_RSP = 0x9B
BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_RSP = 0x9C
BTP_AVRCP_EV_CA_CT_CONNECTED = 0x9D
BTP_AVRCP_EV_CA_CT_DISCONNECTED = 0x9E
BTP_AVRCP_EV_GET_IMAGE_PROPS_RSP = 0x9F
BTP_AVRCP_EV_GET_IMAGE_RSP = 0xA0
BTP_AVRCP_EV_GET_LINKED_THUMBNAIL_RSP = 0xA1
