...
GATTC = {
    "read_supp_cmds": (defs.BTP_SERVICE_ID_GATTC,
                       defs.BTP_CMD_GATTC_READ_SUPPORTED_COMMANDS,
                       defs.BTP_INDEX_NONE, ""),
    "exchange_mtu": (defs.BTP_SERVICE_ID_GATTC,
                     defs.BTP_CMD_GATTC_EXCHANGE_MTU,
                     CONTROLLER_INDEX),
    "disc_all_prim": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_DISC_ALL_PRIM,
                      CONTROLLER_INDEX),
    "disc_prim_uuid": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_DISC_PRIM_UUID,
                       CONTROLLER_INDEX),
    "find_included": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_FIND_INCLUDED,
                      CONTROLLER_INDEX),
    "disc_all_chrc": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_DISC_ALL_CHRC,
                      CONTROLLER_INDEX),
    "disc_chrc_uuid": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_DISC_CHRC_UUID,
                       CONTROLLER_INDEX),
    "disc_all_desc": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_DISC_ALL_DESC,
                      CONTROLLER_INDEX),
    "read": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_READ, CONTROLLER_INDEX),
    "read_uuid": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_READ_UUID,
                  CONTROLLER_INDEX),
    "read_long": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_READ_LONG,
                  CONTROLLER_INDEX),
    "read_multiple": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_READ_MULTIPLE,
                      CONTROLLER_INDEX),
    "write_without_rsp": (defs.BTP_SERVICE_ID_GATTC,
                          defs.BTP_CMD_GATTC_WRITE_WITHOUT_RSP, CONTROLLER_INDEX),
    "signed_write": (defs.BTP_SERVICE_ID_GATTC,
                     defs.BTP_CMD_GATTC_SIGNED_WRITE_WITHOUT_RSP, CONTROLLER_INDEX),
    "write": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_WRITE, CONTROLLER_INDEX),
    "write_long": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_WRITE_LONG,
                   CONTROLLER_INDEX),
    "write_reliable": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_WRITE_RELIABLE,
                       CONTROLLER_INDEX),
    "cfg_notify": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_CFG_NOTIFY,
                   CONTROLLER_INDEX),
    "cfg_indicate": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_CFG_INDICATE,
                     CONTROLLER_INDEX),
    "read_multiple_var": (defs.BTP_SERVICE_ID_GATTC, defs.BTP_CMD_GATTC_READ_MULTIPLE_VAR,
                          CONTROLLER_INDEX),
}
...
GATTC_EV = {
    defs.BTP_EV_GATTC_MTU_EXCHANGED: gatt_cl_mtu_exchanged_ev_,
    defs.BTP_EV_GATTC_DISC_ALL_PRIM_RP: gatt_cl_disc_all_prim_rsp_ev_,
    defs.BTP_EV_GATTC_DISC_PRIM_UUID_RP: gatt_cl_disc_prim_uuid_rsp_ev_,
    defs.BTP_EV_GATTC_FIND_INCLUDED_RP: gatt_cl_find_incld_rsp_ev_,
    defs.BTP_EV_GATTC_DISC_ALL_CHRC_RP: gatt_cl_disc_all_chrc_rsp_ev_,
    defs.BTP_EV_GATTC_DISC_CHRC_UUID_RP: gatt_cl_disc_chrc_uuid_rsp_ev_,
    defs.BTP_EV_GATTC_DISC_ALL_DESC_RP: gatt_cl_disc_all_desc_rsp_ev_,
    defs.BTP_EV_GATTC_READ_RP: gatt_cl_read_rsp_ev_,
    defs.BTP_EV_GATTC_READ_UUID_RP: gatt_cl_read_uuid_rsp_ev_,
    defs.BTP_EV_GATTC_READ_LONG_RP: gatt_cl_read_long_rsp_ev_,
    defs.BTP_EV_GATTC_READ_MULTIPLE_RP: gatt_cl_read_mult_rsp_ev_,
    defs.BTP_EV_GATTC_WRITE_RP: gatt_cl_write_rsp_ev_,
    defs.BTP_EV_GATTC_WRITE_LONG_RP: gatt_cl_write_rsp_ev_,
    defs.BTP_EV_GATTC_RELIABLE_WRITE_RP: gatt_cl_write_rsp_ev_,
    defs.BTP_EV_GATTC_CFG_NOTIFY_RP: gatt_cl_write_rsp_ev_,
    defs.BTP_EV_GATTC_CFG_INDICATE_RP: gatt_cl_write_rsp_ev_,
    defs.BTP_EV_GATTC_EV_NOTIFICATION_RXED: gatt_cl_notification_rxed_ev_,
    defs.BTP_EV_GATTC_READ_MULTIPLE_VAR_RP: gatt_cl_read_mult_var_rsp_ev_,
}
