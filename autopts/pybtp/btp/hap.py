...
def hap_ev_iac_discovery_complete_(hap, data, data_len):
    ...
    hap.event_received(defs.BTP_EV_HAP_IAC_DISCOVERY_COMPLETE, (addr_type, addr, status))
...
def hap_ev_hauc_discovery_complete_(hap, data, data_len):
    ...
    hap.event_received(defs.BTP_EV_HAP_HAUC_DISCOVERY_COMPLETE, (addr_type, addr, status,
...
def hap_ev_preset_changed_(hap, data, data_len):
    ...
    hap.event_received(defs.BTP_EV_HAP_PRESET_READ, (addr_type, addr, change_id,
                                                is_last, preset_index,
                                                prev_index, properties, name))


HAP_EV = {
    defs.BTP_EV_HAP_IAC_DISCOVERY_COMPLETE: hap_ev_iac_discovery_complete_,
    defs.BTP_EV_HAP_HAUC_DISCOVERY_COMPLETE: hap_ev_hauc_discovery_complete_,
    defs.BTP_EV_HAP_PRESET_CHANGED: hap_ev_preset_changed_,
}
