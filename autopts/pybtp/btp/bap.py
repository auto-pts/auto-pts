...
BAP = {
    'read_supported_cmds': (defs.BTP_SERVICE_ID_BAP,
                            defs.BTP_CMD_BAP_READ_SUPPORTED_COMMANDS,
                            CONTROLLER_INDEX),
    'discover': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_DISCOVER,
                 CONTROLLER_INDEX),
    'send': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_SEND, CONTROLLER_INDEX),
    'broadcast_source_setup': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SOURCE_SETUP,
                               CONTROLLER_INDEX),
    'broadcast_source_release': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SOURCE_RELEASE,
                                 CONTROLLER_INDEX),
    'broadcast_adv_start': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_ADV_START,
                            CONTROLLER_INDEX),
    'broadcast_adv_stop': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_ADV_STOP,
                           CONTROLLER_INDEX),
    'broadcast_source_start': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SOURCE_START,
                               CONTROLLER_INDEX),
    'broadcast_source_stop': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SOURCE_STOP,
                              CONTROLLER_INDEX),
    'broadcast_sink_setup': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SINK_SETUP,
                             CONTROLLER_INDEX, ""),
    'broadcast_sink_release': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SINK_RELEASE,
                               CONTROLLER_INDEX, ""),
    'broadcast_scan_start': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SCAN_START,
                             CONTROLLER_INDEX, ""),
    'broadcast_scan_stop': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SCAN_STOP,
                            CONTROLLER_INDEX, ""),
    'broadcast_sink_sync': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SINK_SYNC,
                            CONTROLLER_INDEX),
    'broadcast_sink_stop': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SINK_STOP,
                            CONTROLLER_INDEX),
    'broadcast_sink_bis_sync': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_BROADCAST_SINK_BIS_SYNC,
                                CONTROLLER_INDEX),
    'discover_scan_delegator': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_DISCOVER_SCAN_DELEGATOR,
                                CONTROLLER_INDEX),
    'broadcast_assistant_scan_start': (defs.BTP_SERVICE_ID_BAP,
                                       defs.BTP_CMD_BAP_BROADCAST_ASSISTANT_SCAN_START,
                                       CONTROLLER_INDEX),
    'broadcast_assistant_scan_stop': (defs.BTP_SERVICE_ID_BAP,
                                      defs.BTP_CMD_BAP_BROADCAST_ASSISTANT_SCAN_STOP,
                                      CONTROLLER_INDEX),
    'add_broadcast_src': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_ADD_BROADCAST_SRC,
                          CONTROLLER_INDEX),
    'remove_broadcast_src': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_REMOVE_BROADCAST_SRC,
                             CONTROLLER_INDEX),
    'modify_broadcast_src': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_MODIFY_BROADCAST_SRC,
                             CONTROLLER_INDEX),
    'set_broadcast_code': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_SET_BROADCAST_CODE,
                           CONTROLLER_INDEX),
    'bap_send_past': (defs.BTP_SERVICE_ID_BAP, defs.BTP_CMD_BAP_SEND_PAST, CONTROLLER_INDEX),
}
...
def bap_ev_discovery_completed_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_DISCOVERY_COMPLETED, (addr_type, addr, status))
...
def bap_ev_codec_cap_found_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_CODEC_CAP_FOUND,
...
def bap_ev_ase_found_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_ASE_FOUND, (addr_type, addr, ase_dir, ase_id))
...
def bap_ev_stream_received_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_STREAM_RECEIVED, (addr_type, addr, ase_id, iso_data))
...
def bap_ev_baa_found_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_BAA_FOUND, ev)
...
def bap_ev_bis_found_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_BIS_FOUND, ev)
...
def bap_ev_bis_synced_received_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_BIS_SYNCED, ev)
...
def bap_ev_bis_stream_received_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_BIS_STREAM_RECEIVED, ev)
...
def bap_ev_scan_delegator_found_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_SCAN_DELEGATOR_FOUND, ev)
...
def bap_ev_broadcast_receive_state_(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_BROADCAST_RECEIVE_STATE, ev)
...
def bap_ev_pa_syn_req(bap, data, data_len):
    ...
    bap.event_received(defs.BTP_EV_BAP_PA_SYNC_REQ, ev)


BAP_EV = {
    defs.BTP_EV_BAP_DISCOVERY_COMPLETED: bap_ev_discovery_completed_,
    defs.BTP_EV_BAP_CODEC_CAP_FOUND: bap_ev_codec_cap_found_,
    defs.BTP_EV_BAP_ASE_FOUND: bap_ev_ase_found_,
    defs.BTP_EV_BAP_STREAM_RECEIVED: bap_ev_stream_received_,
    defs.BTP_EV_BAP_BAA_FOUND: bap_ev_baa_found_,
    defs.BTP_EV_BAP_BIS_FOUND: bap_ev_bis_found_,
    defs.BTP_EV_BAP_BIS_SYNCED: bap_ev_bis_synced_received_,
    defs.BTP_EV_BAP_BIS_STREAM_RECEIVED: bap_ev_bis_stream_received_,
    defs.BTP_EV_BAP_SCAN_DELEGATOR_FOUND: bap_ev_scan_delegator_found_,
    defs.BTP_EV_BAP_BROADCAST_RECEIVE_STATE: bap_ev_broadcast_receive_state_,
    defs.BTP_EV_BAP_PA_SYNC_REQ: bap_ev_pa_syn_req,
}
