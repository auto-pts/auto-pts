...
HAS = {
    'read_supported_cmds': ( defs.BTP_SERVICE_ID_HAS,
                             defs.BTP_CMD_HAS_READ_SUPPORTED_COMMANDS,
                             CONTROLLER_INDEX),
    'set_active_index':    ( defs.BTP_SERVICE_ID_HAS, 
                             defs.BTP_CMD_HAS_SET_ACTIVE_INDEX,
                             CONTROLLER_INDEX),
    'set_preset_name':     ( defs.BTP_SERVICE_ID_HAS, 
                             defs.BTP_CMD_HAS_SET_PRESET_NAME,
                             CONTROLLER_INDEX),
    'remove_preset':       ( defs.BTP_SERVICE_ID_HAS, 
                             defs.BTP_CMD_HAS_REMOVE_PRESET,
                             CONTROLLER_INDEX),
    'add_preset':          ( defs.BTP_SERVICE_ID_HAS, 
                             defs.BTP_CMD_HAS_ADD_PRESET,
                             CONTROLLER_INDEX),
    'set_properties':      ( defs.BTP_SERVICE_ID_HAS, 
                             defs.BTP_CMD_HAS_SET_PROPERTIES,
                             CONTROLLER_INDEX)
}
