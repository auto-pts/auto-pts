...
MICS = {
    'read_supported_cmds': (defs.BTP_SERVICE_ID_MICS,
                            defs.BTP_CMD_MICS_READ_SUPPORTED_COMMANDS,
                            CONTROLLER_INDEX, ""),
    'mute_disable':        (defs.BTP_SERVICE_ID_MICS,
                            defs.BTP_CMD_MICS_MUTE_DISABLE,
                            CONTROLLER_INDEX, ""),
    'mute_read':           (defs.BTP_SERVICE_ID_MICS,
                            defs.BTP_CMD_MICS_MUTE_READ,
                            CONTROLLER_INDEX, ""),
    'mute':                (defs.BTP_SERVICE_ID_MICS,
                            defs.BTP_CMD_MICS_MUTE,
                            CONTROLLER_INDEX, ""),
    'unmute':              (defs.BTP_SERVICE_ID_MICS,
                            defs.BTP_CMD_MICS_UNMUTE,
                            CONTROLLER_INDEX, ""),
}
...
def mics_mute_state_ev(mics, data, data_len):
    ...
    mics.event_received(defs.BTP_EV_MICS_MUTE_STATE, mute)


MICS_EV = {
    defs.BTP_EV_MICS_MUTE_STATE: mics_mute_state_ev,
}