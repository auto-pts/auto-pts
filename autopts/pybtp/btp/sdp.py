...
SDP = {
    "search_req": (defs.BTP_SERVICE_ID_SDP, defs.SDP_SEARCH_REQ,
                  CONTROLLER_INDEX_NONE),
    "attr_req": (defs.BTP_SERVICE_ID_SDP, defs.SDP_ATTR_REQ,
                 CONTROLLER_INDEX_NONE),
    "search_attr_req": (defs.BTP_SERVICE_ID_SDP, defs.SDP_SEARCH_ATTR_REQ,
                  CONTROLLER_INDEX_NONE),
}
...
SDP_EV = {
    defs.SDP_EV_SERVICE_RECORD_HANDLE: sdp_service_record_handle_ev_
}
