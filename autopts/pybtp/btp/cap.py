...
CAP = {
    'read_supported_cmds': (defs.BTP_SERVICE_ID_CAP,
                            defs.BTP_CMD_CAP_READ_SUPPORTED_COMMANDS,
                            CONTROLLER_INDEX),
    'discover': (defs.BTP_SERVICE_ID_CAP, defs.BTP_CMD_CAP_DISCOVER, CONTROLLER_INDEX),
    'unicast_setup_ase': (defs.BTP_SERVICE_ID_CAP, defs.BTP_CMD_CAP_UNICAST_SETUP_ASE, CONTROLLER_INDEX),
    'unicast_audio_start': (defs.BTP_SERVICE_ID_CAP, defs.BTP_CMD_CAP_UNICAST_AUDIO_START, CONTROLLER_INDEX),
    'unicast_audio_update': (defs.BTP_SERVICE_ID_CAP, defs.BTP_CMD_CAP_UNICAST_AUDIO_UPDATE, CONTROLLER_INDEX),
    'unicast_audio_stop': (defs.BTP_SERVICE_ID_CAP, defs.BTP_CMD_CAP_UNICAST_AUDIO_STOP, CONTROLLER_INDEX),
    'broadcast_source_setup_stream': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_SETUP_STREAM, CONTROLLER_INDEX),
    'broadcast_source_setup_subgroup': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_SETUP_SUBGROUP, CONTROLLER_INDEX),
    'broadcast_source_setup': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_SETUP, CONTROLLER_INDEX),
    'broadcast_source_release': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_RELEASE, CONTROLLER_INDEX),
    'broadcast_adv_start': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_ADV_START, CONTROLLER_INDEX),
    'broadcast_adv_stop': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_ADV_STOP, CONTROLLER_INDEX),
    'broadcast_source_start': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_START, CONTROLLER_INDEX),
    'broadcast_source_stop': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_STOP, CONTROLLER_INDEX),
    'broadcast_source_update': (defs.BTP_SERVICE_ID_CAP,
        defs.BTP_CMD_CAP_BROADCAST_SOURCE_UPDATE, CONTROLLER_INDEX),
}
...
def cap_ev_discovery_completed_(cap, data, data_len):
    ...
    cap.event_received(defs.BTP_EV_CAP_DISCOVERY_COMPLETED, (addr_type, addr, status))
...
def cap_ev_unicast_start_completed_(cap, data, data_len):
    ...
    cap.event_received(defs.BTP_EV_CAP_UNICAST_START_COMPLETED, (status,))
...
def cap_ev_unicast_stop_completed_(cap, data, data_len):
    ...
    cap.event_received(defs.BTP_EV_CAP_UNICAST_STOP_COMPLETED, (cig_id, status))


CAP_EV = {
    defs.BTP_EV_CAP_DISCOVERY_COMPLETED: cap_ev_discovery_completed_,
    defs.BTP_EV_CAP_UNICAST_START_COMPLETED: cap_ev_unicast_start_completed_,
    defs.BTP_EV_CAP_UNICAST_STOP_COMPLETED: cap_ev_unicast_stop_completed_,
}
