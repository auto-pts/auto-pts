...
def a2dp_ev_get_capabilities_rsp(a2dp, data, data_len):
    ...
    stack.a2dp.status = stack.a2dp.STATUS[defs.BGP_A2DP_EV_GET_CAPABILITIES_RSP]
...
def a2dp_discover():
    ...
    btp.a2dp_wait_for_command_rsp(defs.BGP_A2DP_EV_GET_CAPABILITIES_RSP)
...
A2DP_EV = {
    ...
    defs.BGP_A2DP_EV_GET_CAPABILITIES_RSP: a2dp_ev_get_capabilities_rsp,
