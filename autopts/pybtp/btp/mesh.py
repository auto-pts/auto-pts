...
MESH_EV = {
    defs.BTP_EV_MESH_OUT_NUMBER_ACTION: mesh_out_number_action_ev,
    defs.BTP_EV_MESH_OUT_STRING_ACTION: mesh_out_string_action_ev,
    defs.BTP_EV_MESH_IN_ACTION: mesh_in_action_ev,
    defs.BTP_EV_MESH_PROVISIONED: mesh_provisioned_ev,
    defs.BTP_EV_MESH_PROV_LINK_OPEN: mesh_prov_link_open_ev,
    defs.BTP_EV_MESH_PROV_LINK_CLOSED: mesh_prov_link_closed_ev,
    defs.BTP_EV_MESH_NET_RECV: mesh_net_rcv_ev,
    defs.BTP_EV_MESH_INVALID_BEARER: mesh_invalid_bearer_ev,
    defs.BTP_EV_MESH_INCOMP_TIMER_EXP: mesh_incomp_timer_exp_ev,
    defs.BTP_EV_MESH_FRND_ESTABLISHED: mesh_frnd_established_ev,
    defs.BTP_EV_MESH_FRND_TERMINATED: mesh_frnd_terminated_ev,
    defs.BTP_EV_MESH_LPN_ESTABLISHED: mesh_lpn_established_ev,
    defs.BTP_EV_MESH_LPN_TERMINATED: mesh_lpn_terminated_ev,
    defs.BTP_EV_MESH_LPN_POLLED: mesh_lpn_polled_ev,
    defs.BTP_EV_MESH_PROV_NODE_ADDED: mesh_prov_node_added_ev,
    defs.BTP_EV_MESH_MODEL_RECV: mesh_model_recv_ev,
    defs.BTP_EV_MESH_BLOB_LOST_TARGET: mesh_blob_lost_target_ev,
}
