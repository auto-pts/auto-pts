...
def aics_state_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_STATE, (addr_type, addr, att_status, gain, mute, mode))
...
def aics_gain_setting_prop_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_GAIN_SETTING_PROP, (addr_type, addr, units,
...
def aics_input_type_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_INPUT_TYPE, (addr_type, addr, input_type, att_status))
...
def aics_status_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_STATUS, (addr_type, addr, status, att_status))
...
def aics_description_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_DESCRIPTION, (addr_type, addr, att_status, description))
...
def aics_procedure_ev(aics, data, data_len):
    ...
    aics.event_received(defs.BTP_EV_AICS_PROCEDURE, (addr_type, addr, att_status, opcode))


AICS_EV = {
    defs.BTP_EV_AICS_STATE: aics_state_ev,
    defs.BTP_EV_AICS_GAIN_SETTING_PROP: aics_gain_setting_prop_ev,
    defs.BTP_EV_AICS_INPUT_TYPE: aics_input_type_ev,
    defs.BTP_EV_AICS_STATUS: aics_status_ev,
    defs.BTP_EV_AICS_DESCRIPTION: aics_description_ev,
    defs.BTP_EV_AICS_PROCEDURE: aics_procedure_ev,
}
