...
VCS = {
    "set_vol":(defs.BTP_SERVICE_ID_VCS, defs.BTP_CMD_VCS_SET_VOL,
               CONTROLLER_INDEX),
    "vol_up":(defs.BTP_SERVICE_ID_VCS, defs.BTP_CMD_VCS_VOL_UP,
               CONTROLLER_INDEX, ""),
    "vol_down":(defs.BTP_SERVICE_ID_VCS, defs.BTP_CMD_VCS_VOL_DOWN,
               CONTROLLER_INDEX, ""),
    "mute":(defs.BTP_SERVICE_ID_VCS, defs.BTP_CMD_VCS_MUTE,
               CONTROLLER_INDEX, ""),
    "unmute":(defs.BTP_SERVICE_ID_VCS, defs.BTP_CMD_VCS_UNMUTE,
               CONTROLLER_INDEX, "")
}
