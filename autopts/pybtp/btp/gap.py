...
def gap_encryption_change_ev_(gap, data, data_len):
    ...
    stack.gap.encryption_change_rcvd.data = (_addr_t, _addr, _reason)
...
def gap_pair_v2(bd_addr=None, bd_addr_type=None, mode=defs.BTP_GAP_CMD_PAIR_V2_MODE_4,
                level=defs.BTP_GAP_CMD_PAIR_V2_LEVEL_2, flags=defs.BTP_GAP_CMD_PAIR_V2_FLAG_NONE):
