...
def gap_padv_biginfo_ev_(gap, data, data_len):
    ...
    addr_type, addr, sync_handle, sid, num_bis, encryption = struct.unpack_from(fmt, data)
    ...
    stack = get_stack()
    stack.gap.write_periodic_biginfo(addr, addr_type, sync_handle, sid, num_bis, encryption)
