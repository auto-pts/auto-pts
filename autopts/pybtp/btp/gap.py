...
GAP = {
    "start_adv": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_START_ADVERTISING,
                  CONTROLLER_INDEX),
    "stop_adv": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_STOP_ADVERTISING,
                 CONTROLLER_INDEX, ""),
    "conn": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_CONNECT, CONTROLLER_INDEX),
    "pair": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_PAIR, CONTROLLER_INDEX),
    "unpair": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_UNPAIR, CONTROLLER_INDEX),
    "disconn": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_DISCONNECT,
                CONTROLLER_INDEX),
    "set_io_cap": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_IO_CAP,
                   CONTROLLER_INDEX),
    "set_conn": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_CONNECTABLE,
                 CONTROLLER_INDEX, 1),
    "set_nonconn": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_CONNECTABLE,
                    CONTROLLER_INDEX, 0),
    "set_nondiscov": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_DISCOVERABLE,
                      CONTROLLER_INDEX, defs.GAP_NON_DISCOVERABLE),
    "set_gendiscov": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_DISCOVERABLE,
    ...
    "set_powered_on": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_POWERED,
                       CONTROLLER_INDEX, 1),
    "set_powered_off": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_POWERED,
                        CONTROLLER_INDEX, 0),
    "set_bondable_on": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_BONDABLE,
                        CONTROLLER_INDEX, 1),
    "set_bondable_off": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_BONDABLE,
                         CONTROLLER_INDEX, 0),
    "start_discov": (defs.BTP_SERVICE_ID_GAP,
                     defs.BTP_CMD_GAP_START_DISCOVERY, CONTROLLER_INDEX),
    "stop_discov": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_STOP_DISCOVERY,
                    CONTROLLER_INDEX, ""),
    "read_ctrl_info": (defs.BTP_SERVICE_ID_GAP,
                       defs.BTP_CMD_GAP_READ_CONTROLLER_INFO,
                       CONTROLLER_INDEX, ""),
    "passkey_entry_rsp": (defs.BTP_SERVICE_ID_GAP,
                          defs.BTP_CMD_GAP_PASSKEY_ENTRY,
                          CONTROLLER_INDEX),
    "passkey_confirm_rsp": (defs.BTP_SERVICE_ID_GAP,
                            defs.BTP_CMD_GAP_PASSKEY_CONFIRM,
                            CONTROLLER_INDEX),
    "start_direct_adv": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_START_DIRECT_ADV,
                         CONTROLLER_INDEX),
    "conn_param_update": (defs.BTP_SERVICE_ID_GAP,
                          defs.BTP_CMD_GAP_CONN_PARAM_UPDATE,
                          CONTROLLER_INDEX),
    "pairing_consent_rsp": (defs.BTP_SERVICE_ID_GAP,
                            defs.BTP_CMD_GAP_PAIRING_CONSENT_RSP,
                            CONTROLLER_INDEX),
    "oob_legacy_set_data": (defs.BTP_SERVICE_ID_GAP,
                            defs.BTP_CMD_GAP_OOB_LEGACY_SET_DATA,
                            CONTROLLER_INDEX),
    "oob_sc_get_local_data": (defs.BTP_SERVICE_ID_GAP,
                              defs.BTP_CMD_GAP_OOB_SC_GET_LOCAL_DATA,
                              CONTROLLER_INDEX),
    "oob_sc_set_remote_data": (defs.BTP_SERVICE_ID_GAP,
                               defs.BTP_CMD_GAP_OOB_SC_SET_REMOTE_DATA,
                               CONTROLLER_INDEX),
    "set_mitm_on": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_MITM,
                    CONTROLLER_INDEX, 1),
    "set_mitm_off": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_SET_MITM,
                     CONTROLLER_INDEX, 0),
    "reset": (defs.BTP_SERVICE_ID_GAP, defs.BTP_CMD_GAP_RESET, CONTROLLER_INDEX, ""),
    "set_filter_accept_list": (defs.BTP_SERVICE_ID_GAP,
                               defs.BTP_CMD_GAP_SET_FILTER_ACCEPT_LIST, CONTROLLER_INDEX),
    "set_privacy_on": (defs.BTP_SERVICE_ID_GAP,
                       defs.BTP_CMD_GAP_SET_PRIVACY, CONTROLLER_INDEX, 1),
    "set_privacy_off": (defs.BTP_SERVICE_ID_GAP,
                        defs.BTP_CMD_GAP_SET_PRIVACY, CONTROLLER_INDEX, 0),
    "set_sc_only_on": (defs.BTP_SERVICE_ID_GAP,
                       defs.BTP_CMD_GAP_SET_SC_ONLY, CONTROLLER_INDEX, 1),
    "set_sc_only_off": (defs.BTP_SERVICE_ID_GAP,
                        defs.BTP_CMD_GAP_SET_SC_ONLY, CONTROLLER_INDEX, 0),
    "set_sc_on": (defs.BTP_SERVICE_ID_GAP,
                  defs.BTP_CMD_GAP_SET_SC, CONTROLLER_INDEX, 1),
    "set_sc_off": (defs.BTP_SERVICE_ID_GAP,
                   defs.BTP_CMD_GAP_SET_SC, CONTROLLER_INDEX, 0),
    "set_min_enc_key_size": (defs.BTP_SERVICE_ID_GAP,
                             defs.BTP_CMD_GAP_SET_MIN_ENC_KEY_SIZE, CONTROLLER_INDEX),
    "set_extend_advertising_on": (defs.BTP_SERVICE_ID_GAP,
                                  defs.BTP_CMD_GAP_SET_EXTENDED_ADVERTISING, CONTROLLER_INDEX, 1),
    "set_extend_advertising_off": (defs.BTP_SERVICE_ID_GAP,
                                   defs.BTP_CMD_GAP_SET_EXTENDED_ADVERTISING, CONTROLLER_INDEX, 0),
    "padv_configure": (defs.BTP_SERVICE_ID_GAP,
                       defs.BTP_CMD_GAP_PADV_CONFIGURE, CONTROLLER_INDEX),
    "padv_start": (defs.BTP_SERVICE_ID_GAP,
                   defs.BTP_CMD_GAP_PADV_START, CONTROLLER_INDEX),
    "padv_stop": (defs.BTP_SERVICE_ID_GAP,
                  defs.BTP_CMD_GAP_PADV_STOP, CONTROLLER_INDEX, ""),
    "padv_set_data": (defs.BTP_SERVICE_ID_GAP,
                      defs.BTP_CMD_GAP_PADV_SET_DATA, CONTROLLER_INDEX),
    "padv_create_sync": (defs.BTP_SERVICE_ID_GAP,
                         defs.BTP_CMD_GAP_PADV_CREATE_SYNC, CONTROLLER_INDEX),
    "padv_sync_transfer_set_info": (defs.BTP_SERVICE_ID_GAP,
                                    defs.BTP_CMD_GAP_PADV_SYNC_TRANSFER_SET_INFO,
                                    CONTROLLER_INDEX),
    "padv_sync_transfer_start": (defs.BTP_SERVICE_ID_GAP,
                                 defs.BTP_CMD_GAP_PADV_SYNC_TRANSFER_START,
                                 CONTROLLER_INDEX),
    "padv_sync_transfer_recv": (defs.BTP_SERVICE_ID_GAP,
                                defs.BTP_CMD_GAP_PADV_SYNC_TRANSFER_RECV,
                                CONTROLLER_INDEX),
}
...
GAP_EV = {
    defs.BTP_EV_GAP_NEW_SETTINGS: gap_new_settings_ev_,
    defs.BTP_EV_GAP_DEVICE_FOUND: gap_device_found_ev_,
    defs.BTP_EV_GAP_DEVICE_CONNECTED: gap_connected_ev_,
    defs.BTP_EV_GAP_DEVICE_DISCONNECTED: gap_disconnected_ev_,
    defs.BTP_EV_GAP_PASSKEY_DISPLAY: gap_passkey_disp_ev_,
    defs.BTP_EV_GAP_PASSKEY_ENTRY_REQ: gap_passkey_entry_req_ev_,
    defs.BTP_EV_GAP_PASSKEY_CONFIRM_REQ: gap_passkey_confirm_req_ev_,
    defs.BTP_EV_GAP_IDENTITY_RESOLVED: gap_identity_resolved_ev_,
    defs.BTP_EV_GAP_CONN_PARAM_UPDATE: gap_conn_param_update_ev_,
    defs.BTP_EV_GAP_SEC_LEVEL_CHANGED: gap_sec_level_changed_ev_,
    defs.BTP_EV_GAP_PAIRING_CONSENT_REQ: gap_pairing_consent_ev_,
    defs.BTP_EV_GAP_PAIRING_FAILED: gap_pairing_failed_ev_,
    defs.BTP_EV_GAP_BOND_LOST: gap_bond_lost_ev_,
    defs.BTP_EV_GAP_PERIODIC_SYNC_ESTABLISHED: gap_padv_sync_established_ev_,
    defs.BTP_EV_GAP_PERIODIC_SYNC_LOST: gap_padv_sync_lost_ev_,
    defs.BTP_EV_GAP_PERIODIC_REPORT: gap_padv_report_ev_,
    defs.BTP_EV_GAP_PERIODIC_TRANSFER_RECEIVED: gap_padv_transfer_received_ev_
}
...
def gap_adv_ind_on(ad=None, sd=None, duration=AdDuration.forever, own_addr_type=OwnAddrType.le_identity_address):
    ...
    tuple_data = gap_command_rsp_succ(defs.BTP_CMD_GAP_START_ADVERTISING)
...
def gap_adv_off():
    ...
    tuple_data = gap_command_rsp_succ(defs.BTP_CMD_GAP_STOP_ADVERTISING)
    __gap_current_settings_update(tuple_data)
...
def gap_direct_adv_on(addr, addr_type, high_duty=0, peer_rpa=0):
    ...
    tuple_data = gap_command_rsp_succ(defs.BTP_CMD_GAP_START_DIRECT_ADV)
    __gap_current_settings_update(tuple_data)
...
def gap_unpair(bd_addr=None, bd_addr_type=None):
    ...
    # Expected result
    gap_command_rsp_succ(defs.BTP_CMD_GAP_UNPAIR)
...
def gap_padv_configure(include_tx_power, intvl_min, intvl_max):
    ...
    tuple_data = gap_command_rsp_succ(defs.BTP_CMD_GAP_PADV_CONFIGURE)
    __gap_current_settings_update(tuple_data)
...
def gap_padv_start(flags=0):
    ...
    tuple_data = gap_command_rsp_succ(defs.BTP_CMD_GAP_PADV_START)
    __gap_current_settings_update(tuple_data)
