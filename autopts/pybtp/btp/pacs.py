...
PACS = {
    'update_char': (defs.BTP_SERVICE_ID_PACS, defs.BTP_CMD_PACS_UPDATE_CHARACTERISTIC,
                    CONTROLLER_INDEX),
    'set_location': (defs.BTP_SERVICE_ID_PACS, defs.BTP_CMD_PACS_SET_LOCATION,
                    CONTROLLER_INDEX),
    'set_available_contexts': (defs.BTP_SERVICE_ID_PACS, defs.BTP_CMD_PACS_SET_AVAILABLE_CONTEXTS,
                    CONTROLLER_INDEX),
    'set_supported_contexts': (defs.BTP_SERVICE_ID_PACS, defs.BTP_CMD_PACS_SET_SUPPORTED_CONTEXTS,
                    CONTROLLER_INDEX),
}
...
def pacs_ev_characteristic_subscribed_(pacs, data, data_len):
    ...
    pacs.event_received(defs.BTP_EV_PACS_CHARACTERISTIC_SUBSCRIBED,
                        (addr_type, addr, handle))


PACS_EV = {
    defs.BTP_EV_PACS_CHARACTERISTIC_SUBSCRIBED: pacs_ev_characteristic_subscribed_,
}
