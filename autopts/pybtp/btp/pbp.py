...
PBP = {
    'read_supported_cmds': (defs.BTP_SERVICE_ID_PBP,
                            defs.BTP_CMD_PBP_READ_SUPPORTED_COMMANDS,
                            CONTROLLER_INDEX),
    'set_public_broadcast_announcement': (defs.BTP_SERVICE_ID_PBP,
                                          defs.BTP_CMD_PBP_SET_PUBLIC_BROADCAST_ANNOUNCEMENT,
                                          CONTROLLER_INDEX),
    'set_broadcast_name': (defs.BTP_SERVICE_ID_PBP,
                           defs.BTP_CMD_PBP_SET_BROADCAST_NAME,
                           CONTROLLER_INDEX),
    'broadcast_scan_start': (defs.BTP_SERVICE_ID_PBP,
                             defs.BTP_CMD_PBP_BROADCAST_SCAN_START,
                             CONTROLLER_INDEX),
    'broadcast_scan_stop': (defs.BTP_SERVICE_ID_PBP,
                            defs.BTP_CMD_PBP_BROADCAST_SCAN_STOP,
                            CONTROLLER_INDEX),
}
...
def pbp_ev_public_broadcast_announcement_found(pbp, data, data_len):
    ...
    pbp.event_received(defs.BTP_EV_PBP_PUBLIC_BROADCAST_ANNOUNCEMENT_FOUND, ev)


PBP_EV = {
    defs.BTP_EV_PBP_PUBLIC_BROADCAST_ANNOUNCEMENT_FOUND: pbp_ev_public_broadcast_announcement_found,
}
