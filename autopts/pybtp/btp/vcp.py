...
def vcp_ev_discovery_completed_(vcp, data, data_len):
    ...
    vcp.event_received(defs.BTP_EV_VCP_DISCOVERED, (addr_type, addr, att_status, control_handle,
...
def vcp_state_ev(vcp, data, data_len):
    ...
    vcp.event_received(defs.BTP_EV_VCP_STATE, (addr_type, addr, att_status, volume, mute))
...
def vcp_flags_ev(vcp, data, data_len):
    ...
    vcp.event_received(defs.BTP_EV_VCP_FLAGS, (addr_type, addr, att_status, flags))
...
def vcp_procedure_ev(vcp, data, data_len):
    ...
    vcp.event_received(defs.BTP_EV_VCP_PROCEDURE, (addr_type, addr, att_status, opcode))


VCP_EV = {
    defs.BTP_EV_VCP_DISCOVERED: vcp_ev_discovery_completed_,
    defs.BTP_EV_VCP_STATE: vcp_state_ev,
    defs.BTP_EV_VCP_FLAGS: vcp_flags_ev,
    defs.BTP_EV_VCP_PROCEDURE: vcp_procedure_ev
}