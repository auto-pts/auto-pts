...
GATTS = {
    "add_svc": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_ADD_SERVICE,
                CONTROLLER_INDEX),
    "start_server": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_START_SERVER,
                     CONTROLLER_INDEX, ""),
    "add_inc_svc": (defs.BTP_SERVICE_ID_GATT,
                    defs.BTP_CMD_GATT_ADD_INCLUDED_SERVICE, CONTROLLER_INDEX),
    "add_char": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_ADD_CHARACTERISTIC,
                 CONTROLLER_INDEX),
    "set_val": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_SET_VALUE,
                CONTROLLER_INDEX),
    "add_desc": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_ADD_DESCRIPTOR,
                 CONTROLLER_INDEX),
    "set_enc_key_size": (defs.BTP_SERVICE_ID_GATT,
                         defs.BTP_CMD_GATT_SET_ENC_KEY_SIZE, CONTROLLER_INDEX),
    "get_attrs": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_GET_ATTRIBUTES,
                  CONTROLLER_INDEX),
    "get_attr_val": (defs.BTP_SERVICE_ID_GATT,
                     defs.BTP_CMD_GATT_GET_ATTRIBUTES, CONTROLLER_INDEX),
    "change_database": (defs.BTP_SERVICE_ID_GATT,
                        defs.BTP_CMD_GATT_CHANGE_DATABASE, CONTROLLER_INDEX),
    "notify_mult": (defs.BTP_SERVICE_ID_GATT,
                    defs.BTP_CMD_GATT_NOTIFY_MULTIPLE, CONTROLLER_INDEX),
}

GATTC = {
    "exchange_mtu": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_EXCHANGE_MTU,
                     CONTROLLER_INDEX),
    "disc_all_prim": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_DISC_ALL_PRIM,
                      CONTROLLER_INDEX),
    "disc_prim_uuid": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_DISC_PRIM_UUID,
                       CONTROLLER_INDEX),
    "find_included": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_FIND_INCLUDED,
                      CONTROLLER_INDEX),
    "disc_all_chrc": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_DISC_ALL_CHRC,
                      CONTROLLER_INDEX),
    "disc_chrc_uuid": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_DISC_CHRC_UUID,
                       CONTROLLER_INDEX),
    "disc_all_desc": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_DISC_ALL_DESC,
                      CONTROLLER_INDEX),
    "read": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ, CONTROLLER_INDEX),
    "read_uuid": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_UUID,
                  CONTROLLER_INDEX),
    "read_long": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_LONG,
                  CONTROLLER_INDEX),
    "read_multiple": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_MULTIPLE,
                      CONTROLLER_INDEX),
    "read_multiple_var": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_MULTIPLE_VAR,
                          CONTROLLER_INDEX),
    "write_without_rsp": (defs.BTP_SERVICE_ID_GATT,
                          defs.BTP_CMD_GATT_WRITE_WITHOUT_RSP, CONTROLLER_INDEX),
    "signed_write": (defs.BTP_SERVICE_ID_GATT,
                     defs.BTP_CMD_GATT_SIGNED_WRITE_WITHOUT_RSP, CONTROLLER_INDEX),
    "write": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_WRITE, CONTROLLER_INDEX),
    "write_long": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_WRITE_LONG,
                   CONTROLLER_INDEX),
    "write_reliable": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_WRITE_RELIABLE,
                       CONTROLLER_INDEX),
    "cfg_notify": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_CFG_NOTIFY,
                   CONTROLLER_INDEX),
    "cfg_indicate": (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_CFG_INDICATE,
                     CONTROLLER_INDEX),
    'eatt_connect': (defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_EATT_CONNECT,
                     CONTROLLER_INDEX),
}
...
GATT_EV = {
    ...
    defs.BTP_EV_GATT_NOTIFICATION: gatt_notification_ev_,
}
...
def gatts_get_attrs(start_handle=0x0001, end_handle=0xffff, type_uuid=None):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_GET_ATTRIBUTES)
...
def _gattc_find_included_rsp():
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_FIND_INCLUDED)
...
def gattc_disc_all_chrc_find_attrs_rsp(exp_chars, store_attrs=False):
    ...
    logging.debug("%s received %r %r",
                  ...
                  tuple_data)
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_DISC_ALL_CHRC)
...
def gattc_cfg_indicate(bd_addr_type, bd_addr, enable, ccc_hdl):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_CFG_INDICATE)
...
def gattc_disc_prim_uuid_find_attrs_rsp(exp_svcs, store_attrs=False):
    ...
    logging.debug("%s received %r %r",
                  ...
                  tuple_data)
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_DISC_PRIM_UUID)
...
def gattc_disc_all_prim_rsp(store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_DISC_ALL_PRIM)
...
def gattc_disc_chrc_uuid_rsp(store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_DISC_CHRC_UUID)
...
def gattc_disc_all_desc_rsp(store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_DISC_ALL_DESC)
...
def gattc_read_rsp(store_rsp=False, store_val=False, timeout=None):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ)
...
def gattc_read_uuid_rsp(store_rsp=False, store_val=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_UUID)
...
def gattc_read_long_rsp(store_rsp=False, store_val=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_READ_LONG)
...
def gattc_read_multiple_rsp(store_val=False, store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_READ_MULTIPLE)
...
def gattc_read_multiple_var_rsp(store_val=False, store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_READ_MULTIPLE_VAR)
...
def gattc_write_rsp(store_rsp=False, timeout=None):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT, defs.BTP_CMD_GATT_WRITE)
...
def gattc_write_reliable_rsp(store_rsp=False):
    ...
    btp_hdr_check(tuple_hdr, defs.BTP_SERVICE_ID_GATT,
                  defs.BTP_CMD_GATT_WRITE_RELIABLE)
