...
def avrcp_control_connect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_control_disconnect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_browsing_connect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_browsing_disconnect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_unit_info(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_subunit_info(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_pass_through(opid, state, payload=None, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_caps(cap_id, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_list_player_app_setting_attrs(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_list_player_app_setting_vals(attr_id, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_curr_player_app_setting_val_attr(attr_ids: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_set_player_app_setting_val(attr_vals: list[tuple[int, int]], bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_player_app_setting_attr_text(attr_ids: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_player_app_setting_val_text(attr_id, val_ids: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_play_status(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_element_attrs(attrs: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_register_notification(event_id, interval=0, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_set_absolute_volume(volume, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_set_addressed_player(player_id, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_folder_items(scope, start_item, end_item, attr_list: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_total_number_of_items(scope, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_set_browsed_player(player_id, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_change_path(uid_counter, direction, uid, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_item_attrs(scope, uid, uid_counter, attrs: list, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_play_item(scope, uid, uid_counter, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_search(string, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_add_to_now_playing(scope, uid, uid_counter, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_tg_register_notification(event_id, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_ca_ct_connect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_ca_ct_disconnect(bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_image_props(image_handle, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_image(image_handle, image_desc="", bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def avrcp_get_linked_thumbnail(image_handle, bd_addr=None, bd_addr_type=defs.BTP_BR_ADDRESS_TYPE):
...
def _avrcp_ev_decode_addr(data):
    ...
    addr_type, addr = struct.unpack_from(hdr, data)
    if addr_type != defs.BTP_BR_ADDRESS_TYPE:
        raise BTPError('Invalid address type')
