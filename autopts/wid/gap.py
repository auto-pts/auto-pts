...
GAP_ISO_SYNC_TESTS = ['GAP/BIS/BSE/BV-01-C', 'GAP/SEC/SEM/BI-13-C']
...
def hdl_wid_300(params: WIDParams):
    ...
    if params.test_case_name in ['GAP/SEC/SEM/BV-34-C', 'GAP/SEC/SEM/BV-35-C']:
        ...
        btp.gap_create_big(0, 1, 10000, 20, broadcast_code)
...
def hdl_wid_301(params: WIDParams):
    ...
    if params.test_case_name in GAP_ISO_SYNC_TESTS:
...
def hdl_wid_352(params: WIDParams):
    ...
    if params.test_case_name not in GAP_ISO_SYNC_TESTS:
        addr = pts_addr_get()
