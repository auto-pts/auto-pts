...
from autopts.wid.bap import create_default_config, get_audio_locations_from_pac, BAS_CONFIG_SETTINGS
...
def hdl_wid_376(_: WIDParams):
    ...
    for ev in stack.bap.event_queues[defs.BTP_EV_BAP_ASE_FOUND]:
