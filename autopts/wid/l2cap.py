...
def hdl_wid_251(_: WIDParams):
    ...
    if reason == L2CapChannelStatusCodes.INSUFFICIENT_ENCRYPTION:
        return True
    return False
...
def hdl_wid_252(_: WIDParams):
    ...
    stack.l2cap.wait_for_conn_req_reject_ev()
    reason = stack.l2cap.conn_req_reject_reason
    if reason == L2CapChannelStatusCodes.INSUFFICIENT_AUTHENTICATION:
        return True
    return False
...
def hdl_wid_253(_: WIDParams):
    ...
    stack.l2cap.wait_for_conn_req_reject_ev()
    reason = stack.l2cap.conn_req_reject_reason
    if reason == L2CapChannelStatusCodes.INSUFFICIENT_AUTHORIZATION:
        return True
    return False
...
def hdl_wid_254(_: WIDParams):
    ...
    stack.l2cap.wait_for_conn_req_reject_ev()
    reason = stack.l2cap.conn_req_reject_reason
    if reason == L2CapChannelStatusCodes.INSUFFICIENT_ENCRYPTION_KEY_SIZE:
        return True
    return False
