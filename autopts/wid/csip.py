...
def hdl_wid_13(params: WIDParams):
    ...
    stack = get_stack()
    sirk = stack.csip.event_queues[defs.BTP_EV_CSIP_SIRK][0][2]
...
def hdl_wid_14(params: WIDParams):
    ...
    if stack.csip.event_queues[defs.BTP_EV_CSIP_DISCOVERED] != []:
        return False
...
def hdl_wid_20206(params: WIDParams):
    ...
    chars = stack.csip.event_queues[defs.BTP_EV_CSIP_DISCOVERED][0][3:]
