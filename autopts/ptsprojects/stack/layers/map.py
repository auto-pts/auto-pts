...
class MAPSupportedFeatures(IntEnum):
    ...
    EXT_EVENT_REPORT_V11 = 1 << 6
    EXT_EVENT_REPORT_V12 = 1 << 7
    MSG_FORMAT_V11 = 1 << 8
    MSG_LISTING_FORMAT_V11 = 1 << 9
    PERSISTENT_MSG_HANDLE = 1 << 10
    DB_ID = 1 << 11
    FOLDER_VER_CNTR = 1 << 12
    CONVO_VER_CNTR = 1 << 13
    PARTICIPANT_PRESENCE_CHANGE_NTF = 1 << 14
    PARTICIPANT_CHAT_STATE_CHANGE_NTF = 1 << 15
    PBAP_CONTACT_XREF = 1 << 16
    NTF_FILTERING = 1 << 17
    UTC_OFFSET_TIMESTAMP_FORMAT = 1 << 18
    SUPPORTED_FEATURES_CONN_REQ = 1 << 19
    CONVO_LISTING = 1 << 20
    OWNER_STATUS = 1 << 21
    MSG_FORWARDING = 1 << 22
...
class MAPEvent:
    ...
    def _get_event_type_string(self) -> str:
        ...
        event_map = {
            MAPEventType.NEW_MSG: "NewMessage",
            ...
            MAPEventType.MEM_FULL: "MemoryFull",
            MAPEventType.MEM_AVAIL: "MemoryAvailable",
            MAPEventType.MSG_DELETED: "MessageDeleted",
            MAPEventType.MSG_SHIFT: "MessageShift",
            MAPEventType.READ_STATUS_CHANGED: "ReadStatusChanged",
            MAPEventType.CONVO_CHANGED: "ConversationChanged",
            ...
            MAPEventType.MSG_EXT_DATA_CHANGED: "MessageExtendedDataChanged",
            MAPEventType.MSG_REMOVED: "MessageRemoved",
        }
...
def create_sample_messages(storage: MAPMsgStorage, count: int = 10):
    ...
    for i in range(count):
        ...
        if msg_type == MAPMsgType.IM:
            ...
            im_conversations.append(conversation_id)
