...
def test_cases(ptses):
    ...
    br_l2cap_success_fc = br_l2cap + [
        TestFunc(btp.l2cap_br_listen_v2, br_psm, br_initial_mtu,
                 L2CAPConnectionResponse.insufficient_encryption, defs.L2CAP_LISTEN_OPT_FC),
    ]
    ...
    br_l2cap_success_stream = br_l2cap + [
        TestFunc(btp.l2cap_br_listen_v2, br_psm, br_initial_mtu,
                 L2CAPConnectionResponse.insufficient_encryption, defs.L2CAP_LISTEN_OPT_STREAM),
    ]
    ...
    br_l2cap_success_eret_optional = br_l2cap + [
        TestFunc(btp.l2cap_br_listen_v2, br_psm, br_initial_mtu,
                 L2CAPConnectionResponse.insufficient_encryption, defs.L2CAP_LISTEN_OPT_ERET |
                 defs.L2CAP_LISTEN_OPT_MODE_OPTIONAL),
    ]
    ...
    br_l2cap_success_eret_extended_control = br_l2cap + [
        TestFunc(btp.l2cap_br_listen_v2, br_psm, br_initial_mtu,
                 L2CAPConnectionResponse.insufficient_encryption, defs.L2CAP_LISTEN_OPT_ERET |
                 defs.L2CAP_LISTEN_OPT_EXT_WIN_SIZE),
    ]
