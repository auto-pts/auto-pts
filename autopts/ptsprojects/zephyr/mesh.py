...
def test_cases(ptses):
    ...
    custom_test_cases = [
        ...
        ZTestCase("MESH", "MESH/CL/MPXS/BV-06-C", cmds=pre_conditions_prov +
                  [TestFunc(stack.gatt_init),
                   TestFunc(btp.set_pts_addr, pts.q_bd_addr, Addr.le_public)],
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+0a)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+0b)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+0c)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+1a)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+1b)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+1c)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+2)-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/NODE/TNPT/BV-(XX+3)-C", cmds=pre_conditions +
        ...
        ZTestCase("MESH", "MESH/SR/SAR/BV-02-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/CL/SAR/BV-01-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/CL/SAR/BV-02-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ...
        ZTestCase("MESH", "MESH/SR/LCD/MMD/BV-01-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/CL/LCD/LCMP/BV-01-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
        ZTestCase("MESH", "MESH/CL/LCD/MMD/BV-01-C", cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl),
    ...
    test_cases_lt2 = [
        ...
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-14b-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-14b-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-15-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-15-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-15b-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-15b-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-17-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-17-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-17b-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-17b-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-19-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-19-C_LT2"),
        ZTestCase("MESH", "MESH/SR/RPR/LNK/BV-19b-C",
                  cmds=pre_conditions,
                  generic_wid_hdl=mesh_wid_hdl,
                  lt2="MESH/SR/RPR/LNK/BV-19b-C_LT2"),
    ...
    test_cases_slaves = [
        ...
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-14-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-14b-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-15-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-15b-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-17-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-17b-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-19-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
        ZTestCaseSlave("MESH", "MESH/SR/RPR/LNK/BV-19b-C_LT2",
                       cmds=pre_conditions_slave,
                       generic_wid_hdl=mesh_wid_hdl_rpr_2ptses),
