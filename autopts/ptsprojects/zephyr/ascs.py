...
from autopts.ptsprojects.zephyr.ascs_wid import ascs_wid_hdl
from autopts.ptsprojects.zephyr.ztestcase import ZTestCase
from autopts.pybtp.types import Addr


def set_pixits(ptses):
    """Setup ASCS profile PIXITS for workspace. Those values are used for test
    ...
    pts.set_pixit("ASCS", "TSPX_bd_addr_iut", "DEADBEEFDEAD")
...
def test_cases(ptses):
    """Returns a list of ASCS Server test cases"""
    ...
    pre_conditions = [TestFunc(btp.core_reg_svc_gap),
                      ...
                      TestFunc(lambda: pts.update_pixit_param(
                          "ASCS", "TSPX_bd_addr_iut",
                          stack.gap.iut_addr_get_str())),
                      TestFunc(lambda: pts.update_pixit_param(
                          "ASCS", "TSPX_iut_use_dynamic_bd_addr",
    ...
    test_case_name_list = pts.get_test_case_list('ASCS')
    tc_list = []

    for tc_name in test_case_name_list:
        instance = ZTestCase("ASCS", tc_name,
                             cmds=pre_conditions,
                             generic_wid_hdl=ascs_wid_hdl)
