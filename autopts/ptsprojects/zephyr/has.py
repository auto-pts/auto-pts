...
def set_pixits(ptses):
    ...
    pts.set_pixit("HAS", "TSPX_largest_preset_index", 3)
    pts.set_pixit("HAS", "TSPX_num_presets", 2)
    pts.set_pixit("HAS", "TSPX_available_preset_index", "1,2")
    pts.set_pixit("HAS", "TSPX_unavailable_preset_index", "3")
    pts.set_pixit("HAS", "TSPX_writable_preset_index", "1,2")
    pts.set_pixit("HAS", "TSPX_unwritable_preset_index", "")


def test_cases(ptses):
    """Returns a list of HAS Server test cases"""
