...
class TestCaseRunStats:
    ...
    def get_results(self):
        ...
        for tc_xml in root.findall("./test_case"):
            ...
            test_start_time = tc_xml.attrib.get("test_start_time", None)
            test_end_time = tc_xml.attrib.get("test_end_time", None)
            duration = tc_xml.attrib.get("duration", None)
            results[tc_xml.attrib["name"]] = (status, run_count, test_start_time, test_end_time, duration)
